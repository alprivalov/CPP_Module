...
{
    std::cout << this->_name << "Default constructor called ClapTrap" << std::endl;
    return;
}
...
{
    std::cout << "Constructor parametric called ClapTrap" << std::endl;
    return;
}
...
{
    std::cout << this->_name << "Copy constructor called ClapTrap" << std::endl;
    *this = src;
    return;
}
...
ClapTrap & ClapTrap::operator=(ClapTrap const & rhs){
    std::cout << this->_name << "Copy assignment operator called ClapTrap" << std::endl;
